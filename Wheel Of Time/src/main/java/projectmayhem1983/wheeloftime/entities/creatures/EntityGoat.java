...
public class EntityGoat {
	...
	public static void createEntity(Class entityClass, String entityName, int solidColor, int spotColor){
		...
		EntityRegistry.addSpawn(entityClass, 2, 0, 3, EnumCreatureType.creature, new BiomeGenBase[]{BiomeGenBase.beach, BiomeGenBase.birchForest,BiomeGenBase.birchForestHills,
