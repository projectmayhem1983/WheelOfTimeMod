...
public class EntityDamane {
	public static void WheelOfTime(){
		registerEntity();
	}
	public static void registerEntity(){
		
		createEntity(EntityDamaneMob.class,"Damane Mob",0xA42530, 0x666123);
	...
	public static void createEntity(Class entityClass, String entityName, int solidColor, int spotColor){
		...
		EntityRegistry.addSpawn(entityClass, 80, 1, 1, EnumCreatureType.monster, new BiomeGenBase[]{BiomeGenBase.beach, BiomeGenBase.birchForest,BiomeGenBase.birchForestHills,
