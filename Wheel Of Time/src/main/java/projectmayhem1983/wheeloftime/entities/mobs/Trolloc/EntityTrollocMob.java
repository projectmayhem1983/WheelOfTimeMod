package projectmayhem1983.wheeloftime.entities.mobs.Trolloc;
...
public class EntityTrollocMob extends EntityMob{
	...
	public EntityTrollocMob(World world) {
        ...
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, EntityWhitecloak.class, 1.2D, true));
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityWhitecloak.class, 0, false));
