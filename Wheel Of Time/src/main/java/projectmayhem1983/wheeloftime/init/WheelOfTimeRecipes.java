...
public class WheelOfTimeRecipes {
	...
	public static void init(){
		...
		//Recipes
				GameRegistry.addRecipe(new ItemStack(WheelOfTimeBlocks.blockCuendillar), new Object[]{"CCC","CCC","CCC",'C',WheelOfTimeItems.itemCuendillar});
				...
				GameRegistry.addRecipe(new ItemStack(WheelOfTimeItems.itemCuendillar), new Object[]{"CCC","CCC","CCC",'C',WheelOfTimeItems.itemPowerdust});
